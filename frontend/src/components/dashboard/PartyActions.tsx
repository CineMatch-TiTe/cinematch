...
export function PartyActions() {
  ...
  const handleCreateParty = () => {
    startTransition(async () => {
      ...
      if (result) {
        if ('requirePreferences' in result && result.requirePreferences) {
          toast.info('Please set your preferences before creating a party.')
  ...
  return (
    <>
      ...
      <PreferencesDialog open={showPreferences} onOpenChangeAction={setShowPreferences} />
    </>
  )
}
