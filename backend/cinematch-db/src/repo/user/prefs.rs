...
impl Database {
    ...
    pub(crate) async fn add_user_include_genre(
        &self,
        _user_id: Uuid,
        _genre_id: Uuid,
    ) -> DbResult<()> {
    ...
    pub(crate) async fn remove_user_include_genre(
        &self,
        _user_id: Uuid,
        _genre_id: Uuid,
    ) -> DbResult<()> {
    ...
    pub(crate) async fn add_user_exclude_genre(
        &self,
        _user_id: Uuid,
        _genre_id: Uuid,
    ) -> DbResult<()> {
    ...
    pub(crate) async fn remove_user_exclude_genre(
        &self,
        _user_id: Uuid,
        _genre_id: Uuid,
    ) -> DbResult<()> {
    ...
    pub(crate) async fn get_user_include_genres(&self, _user_id: Uuid) -> DbResult<Vec<Uuid>> {
        use crate::schema::prefs_include_genre::dsl::*;
        let mut conn = self.conn().await?;
    ...
    pub(crate) async fn get_user_exclude_genres(&self, _user_id: Uuid) -> DbResult<Vec<Uuid>> {
        use crate::schema::prefs_exclude_genre::dsl::*;
        let mut conn = self.conn().await?;
